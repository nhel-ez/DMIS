<center>
    <div class="table-box" id="documentListTable">
        <table class="min-w-full divide-gray-200 scroll" id="DocumentListTable">
            <thead>
                <tr>
    ...
    <script>
        ...
        $(document).ready( function () {
            var document = $('#DocumentListTable').DataTable({
        ...
        // Data Tables Search
        $('#documentListTable').show();
  
        $('#mySearchDocumentlist').keyup( function() {
            $('#documentListTable').show();
            document.search($(this).val()).draw();
        });
